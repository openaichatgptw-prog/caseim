...
def extraer_items_sqlserver():
    ...
    # Esquema vacío para asegurar tipos consistentes
    duck.execute(f"""
...
# =========================================================
# 5. PRECIO FAMILIA + CRUCE CON LISTA (JOINS BLINDADOS) + SALIDA Query1
# =========================================================
def calcular_precio_lista():
    ...
    # =========================================================
    # 5.1 PRECIO_FAMILIA (ganador por familia) - JOINS BLINDADOS
    # =========================================================
    duck.execute(f"""
    ...
    # =========================================================
    # 5.2 CARGA EXCEL LISTA + TABLA (ref_lista normalizada)
    # =========================================================
    ...
    # =========================================================
    # 5.3 RESULTADO FINAL (SALIDA IDÉNTICA A Query1) + JOIN BLINDADO
    # =========================================================
    duck.execute("""
    ...
    SELECT
        ...
        pf.Referencia_Activa AS Referencia_Activa,
    ...
    LEFT JOIN precio_familia pf
        ON UPPER(TRIM(pl.ref_lista)) = UPPER(TRIM(pf.Referencia_Principal));
    """)
